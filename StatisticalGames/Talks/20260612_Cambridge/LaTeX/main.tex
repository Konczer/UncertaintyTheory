...
\date{NLIP Seminar Series \\
Department of Computer Science \& Technology
\\
\vspace{12pt}
%\includegraphics[width=0.08\textwidth]{img/logos/Coat_of_Arms_of_the_University_of_Cambridge.png}\\
University of Cambridge \\ 12 Jun 2026}
...
\begin{columns}
    ...
    \begin{itemize}
        \item Omnipresent uncertainty
        \item Different schools of statistics
        \begin{itemize}
            \item ``Frequentist''
            \item Bayesian
            \item \dots
        \end{itemize}
        \item Robust methods without assumed distributions
        \item Settling the question of priors
        \item High stakes / data scarce problems
    \end{itemize}
...
\begin{column}{0.45\textwidth}
    \begin{figure}
    \centering
        \includegraphics[width=0.95\textwidth]{img/Wanderer.jpeg}
    \end{figure}
\end{column}
...
\begin{frame}{Big picture}
    ...
    \begin{itemize}
        \item Strategic behaviour over epistemology
        \item Game theory can provide robust strategies
        \item Project a fictional opponent to the unknown
        \item Equilibrium strategy for the Agent
        \begin{itemize}
            \item Based on Actions $\mathcal{A}$,
            \item Unknown possible States $\Theta$
            \item Matrix of rewards or Utilities $U: \mathcal{A} \times \Theta \mapsto \mathbb{R}$
        \end{itemize}
    \end{itemize}
...
\begin{column}{0.45\textwidth}
    \begin{figure}
    \centering
        \includegraphics[width=0.95\textwidth]{img/RegretGhost.png}
    \end{figure}
\end{column}
...
\begin{itemize}
        ...
        \begin{itemize}
            \item then chooses an $M$-long binary sequence available for the chosen scenario.
            \begin{itemize}
                \item with $K_A$ 1-s in case of scenario A
                \item and $K_B$ 1-s in case of scenario B
            \end{itemize}
        \end{itemize}
\end{itemize}
\\
...
\begin{itemize}
    \item The probability of making an error does not depend on the distribution of the scenarios i.e. the method is robust.
\end{itemize}
...
\begin{itemize}
    \item How would you bet if $\Pr(A)=80\%$, $\Pr(B)=20\%$?
\end{itemize}
...
\begin{frame}{}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{img/pp_gamma_P.pdf}
    \caption{\small \centering Betting strategies for expected utility maximizing agents that adopt isoelastic utilities: $p'_\gamma(P)$}
    \label{fig:IsoelasticUtility}
\end{figure}
\end{frame}
...
\section{Collaboration \& Future work}
...
\begin{itemize}
    ...
    \item \href{https://arxiv.org/abs/2503.01889}{Generalizing Game Theory} with a player representing uncertainty $\checkmark$
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Generative Adversarial Networks (GANs), and Self-play techniques
        \item Reinforcement learning
    \end{itemize}
    
    \item Computer Scientists
    \begin{itemize}
        \item Finding effective and scalable algorithms to calculate or approximate equilibrium strategies
    \end{itemize}

    \item Mathematicians
    \begin{itemize}
        \item  Fertile ground for various mathematical explorations, e.g. asymptotic analysis and convergence of equilibrium quantities
    \end{itemize}
    ...
    \item Economists
    \begin{itemize}
        \item Ambiguity aversion i.e. Ellsberg paradox
    \end{itemize}
...
\centering \Huge
  ...
  \href{mailto:konczer.j@gmail.com}{konczer.j@gmail.com},
        ...
        \href{https://github.com/Konczer/UncertaintyTheory/tree/main/StatisticalGames/Blog}{Blog version}
